...
class ScoringStrategy:
    ...
    def update_player_ratings(cls, game: Game):
        """Calculates and updates the elo attributes of the players from a Game object.
        No update if there is no winner (Draw).
        """
        if not game.winner:
            return

        # On extrait les joueurs et le gagnant directement depuis l'objet game
        p1 = game.player1
        p2 = game.player2
